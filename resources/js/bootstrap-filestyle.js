...
(function($) {"use strict";
	...
	Filestyle.prototype = {
		clear : function() {
			...
			this.$elementFilestyle.find('.clearBtn').hide();
		},
		...
		pushNameFiles : function() {
			...
			if (content !== '') {
				...
				this.$elementFilestyle.find('.clearBtn').show();
			} else {
				this.$elementFilestyle.find(':text').val('');
				this.$elementFilestyle.find('.clearBtn').hide();
			}
		...
		constructor : function() {
			...
			btn +=  '<label for="' + id + 'clear" class="btn ' + _self.options.buttonName + ' ' + 
			(_self.options.size == 'nr' ? '' : 'btn-' + _self.options.size) + ' clearBtn" ' + 
			(_self.options.disabled || _self.$element.attr('disabled') ? 'disabled="true"' : '') + '>' + 
			_self.htmlIcon() + '<div class="buttonText">' + _self.options.clearbuttonText + '</div>' + 
			  '</label>';
